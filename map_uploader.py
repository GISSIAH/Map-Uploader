...
class MapUpload:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&Map Uploader')
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/map_uploader/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Uploads map layers to hosted web map'),
            callback=self.run,
